...
class FriendGraph(object):
    ...
    def nonrec_are_connected(self, name1, name2):
        """Is this name1 friends with name2?
            Non-recursive way
        """
        current = self.nodes[name1] # current node
        to_check = current.adjacent # to check is a set of nodes
    ...
    def are_connected(self, name1, name2, seen=set()):
        """Is this name1 friends with name2?
            Recursive way
        """

        if name1 == name2: #base case
            return True
